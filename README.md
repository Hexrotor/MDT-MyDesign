...
#### 集群攻击v1.1
控制一种单位(默认Arkyid)Pathfind并攻击范围内的敌方炮塔与核心，或召唤设定范围内的同类友军群攻敌人，带远程追踪（不能避障）。通过操控"电弧"可控制单位：长按任意区域进入玩家控制模式，再次长按退出控制。某种程度上此逻辑兼容任何单位。<br>
